document.addEventListener("DOMContentLoaded", () => {
  ...
  function shareActivity(activityName, activityDescription, platform) {
    ...
    switch (platform) {
      ...
      case 'facebook':
        ...
        break;
      case 'email':
        window.location.href = `mailto:?subject=${encodeURIComponent(activityName + ' at Mergington High School')}&body=${encodedText}%0A%0A${encodedUrl}`;
        break;
      case 'copy':
  ...
  function renderActivityCard(name, details) {
    ...
    activityCard.innerHTML = `
      ...
      <div class="share-buttons">
        ...
        <button class="share-button copy" data-activity="${name}" data-description="${details.description.replace(/"/g, '&quot;')}" title="Copy link">
          <svg viewBox="0 0 24 24" width="16" height="16">
    ...
    shareButtons.forEach((button) => {
      button.addEventListener("click", (event) => {
        ...
        const platform = button.classList.contains('twitter') ? 'twitter' :
                        ...
                        button.classList.contains('email') ? 'email' : 'copy';
        shareActivity(activityName, activityDescription, platform);
      });
    });
